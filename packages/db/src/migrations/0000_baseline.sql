...
CREATE TYPE "public"."work_item_source_type" AS ENUM('batch', 'state_machine', 'manual', 'campaign', 'workflow');--> statement-breakpoint
...
CREATE TABLE "audio_cache" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"expires_at" timestamp with time zone,
	CONSTRAINT "audio_cache_hook_event_id_voice_id_unique" UNIQUE("hook_event_id","voice_id")
);
--> statement-breakpoint
...
CREATE TABLE "crm_ai_calls" (
	...
	"caller_identified" boolean DEFAULT false,
	"identified_entity_type" text,
	"identified_entity_id" uuid,
...
CREATE TABLE "work_items" (
	...
	"result" jsonb,
	"metadata" jsonb DEFAULT '{}'::jsonb NOT NULL,
	"source_type" "work_item_source_type",
	"source_id" uuid,
	"deleted_at" timestamp with time zone,
	"can_be_revived" boolean DEFAULT true NOT NULL,
	"revival_count" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE "crm_timeline_events" ADD CONSTRAINT "crm_timeline_events_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "llm_configs" ADD CONSTRAINT "llm_configs_credential_id_llm_credentials_id_fk" FOREIGN KEY ("credential_id") REFERENCES "public"."llm_credentials"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "api_usage_snapshots_provider_created_idx" ON "api_usage_snapshots" USING btree ("provider","created_at");--> statement-breakpoint
...
CREATE INDEX "claude_sessions_current_agent_type_idx" ON "claude_sessions" USING btree ("current_agent_type");--> statement-breakpoint
...
CREATE INDEX "idx_crm_ai_call_scripts_purpose" ON "crm_ai_call_scripts" USING btree ("purpose");--> statement-breakpoint
...
CREATE INDEX "idx_crm_ai_calls_script_id" ON "crm_ai_calls" USING btree ("script_id");--> statement-breakpoint
...
CREATE INDEX "crm_meetings_status_idx" ON "crm_meetings" USING btree ("status");--> statement-breakpoint
...
CREATE INDEX "crm_sms_rate_workspace_idx" ON "crm_sms_rate_limits" USING btree ("workspace_id");--> statement-breakpoint
...
CREATE INDEX "idx_crm_sms_templates_is_active" ON "crm_sms_templates" USING btree ("is_active");--> statement-breakpoint
...
CREATE INDEX "crm_sync_log_started_at_idx" ON "crm_sync_logs" USING btree ("started_at");--> statement-breakpoint
...
CREATE INDEX "idx_crm_tickets_ticket_number" ON "crm_tickets" USING btree ("workspace_id","ticket_number");--> statement-breakpoint
...
CREATE INDEX "crm_webhook_sub_active_idx" ON "crm_webhook_subscriptions" USING btree ("is_active");--> statement-breakpoint
...
CREATE INDEX "crm_workflow_approvals_workflow_idx" ON "crm_workflow_approvals" USING btree ("workflow_id");--> statement-breakpoint
...
CREATE INDEX "hook_events_transaction_id_idx" ON "hook_events" USING btree ("transaction_id");--> statement-breakpoint
...
CREATE INDEX "hook_events_created_at_idx" ON "hook_events" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "hook_events_agent_type_idx" ON "hook_events" USING btree ("agent_type");--> statement-breakpoint
...
CREATE INDEX "idx_work_items_source" ON "work_items" USING btree ("source_type","source_id");--> statement-breakpoint
...
CREATE INDEX "idx_workspace_suggestions_severity" ON "workspace_suggestions" USING btree ("severity");