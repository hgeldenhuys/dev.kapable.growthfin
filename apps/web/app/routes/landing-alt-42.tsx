...
export default function LandingAlt42() {
    ...
    <div className={cn(
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className={cn(
          ...
          theme === "dark" ? "bg-blue-600/40" : "bg-blue-400/40"
        )} />
        <div className={cn(
            "absolute inset-0 opacity-[0.03] dark:opacity-[0.05] pointer-events-none bg-[radial-gradient(circle_at_center,currentColor_1px,transparent_1px)] bg-[size:50px_50px]"
        )} />
      </div>
      ...
      <nav className={cn(
        ...
        theme === "dark" ? "border-white/5 bg-black/50 backdrop-blur-xl" : "border-black/5 bg-white/70 backdrop-blur-xl shadow-sm"
      )}>
        <div className="container mx-auto px-10 h-24 flex items-center justify-between">
          <div className="flex items-center gap-5 group cursor-pointer text-left">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[7px] font-bold uppercase tracking-[0.5em] opacity-40 mt-1">Silicon Cape // HQ</span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-12 text-[10px] font-black uppercase tracking-[0.4em] opacity-50">
            ...
            <a href="#logic" className="hover:text-blue-600 transition-colors">Logic Units</a>
            <a href="#compliance" className="hover:text-blue-600 transition-colors">Compliance</a>
          </div>

          <div className="flex items-center gap-8">
            <button onClick={toggleTheme} className="h-10 w-10 rounded-full flex items-center justify-center hover:bg-blue-600/5 transition-colors">
              {theme === "dark" ? <Sun className="h-4 w-4 opacity-40" /> : <Moon className="h-4 w-4 opacity-40" />}
            </button>
            <div className="h-8 w-px bg-current/10 mx-2" />
      ...
      {/* Hero Section: Engineered for No Overlap & Absolute Impact */}
      <section className="relative min-h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }}
            className="flex flex-col items-center max-w-[1500px] -mt-12"
          >
            <Badge className={cn(
              ...
              High-Velocity Lead Orchestration // v4.4.1 // silicon cape
            </Badge>
            
            <h1 className="text-6xl md:text-8xl lg:text-[11rem] xl:text-[14rem] font-black tracking-tighter mb-10 leading-[0.75] uppercase italic text-center shrink-0">
              <span className="block text-current">Powering</span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-700 inline-block not-italic pb-4 leading-tight">
                Cape Growth.
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-50 max-w-4xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              Agios AI is the high-fidelity orchestration layer for South Africa's most aggressive financial lead pipelines. Built for the R100M+ ecosystem.
            </p>
      ...
      {/* Grid: High Fidelity Impact - More Spacing & Light Mode Friendly */}
      <section id="pipeline" className={cn(
          "py-72 border-y transition-colors shrink-0 relative z-10",
          theme === "dark" ? "bg-[#020617] border-white/5 shadow-[inset_0_0_150px_rgba(0,0,0,0.5)]" : "bg-white border-slate-200 shadow-inner"
      )}>
        <div className="container mx-auto px-16 max-w-[1600px]">
            <div className="max-w-4xl text-left mb-48 space-y-4">
                ...
                <p className="text-2xl opacity-40 font-light max-w-2xl leading-relaxed">High-fidelity qualification at absolute scale. Built for the high-velocity South African fintech economy.</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-52 text-left">
                <div className="flex-1 space-y-28">
                    <div className="space-y-12 text-left">
                        ...
                        <h2 className="text-6xl md:text-8xl lg:text-[11rem] font-black uppercase tracking-tighter leading-none italic text-current">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-24 text-left">
                        {[
                            ...
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness and FSR credit data." },
                        ].map((item, i) => (
                ...
                <div className="w-full lg:w-[45%] relative shrink-0">
                    <div className={cn(
                        ...
                        <div className="flex items-center justify-between opacity-30 text-[11px] font-black uppercase tracking-[0.8em]">
                            <span>Unit_Alpha_v4.4</span>
                            <div className="h-3 w-3 rounded-full bg-blue-600 animate-pulse" />
                        </div>
                        
                        <div className="flex-1 flex flex-col justify-center items-center relative">
                            <Activity className="h-32 w-32 text-blue-600 mb-16 animate-pulse opacity-40" />
                            <div className="text-center space-y-6 relative z-10">
                                <div className="text-6xl lg:text-8xl font-black italic uppercase tracking-tighter leading-none">Synchronized</div>
                        ...
                        <div className="flex items-center justify-between border-t border-blue-600/20 pt-12">
                            <div className="flex flex-col gap-3">
                                <span className="text-[12px] font-black uppercase opacity-40 tracking-widest leading-none">Latency</span>
                                <span className="text-4xl font-black italic leading-none text-current">12.4ms</span>
                            </div>
                    ...
                    {/* Visual Offset */}
                    <div className="absolute -top-16 -left-16 p-12 border border-blue-600/20 shadow-3xl hidden md:block backdrop-blur-3xl transition-all duration-1000">
      ...
      <section id="compliance" className={cn(
        ...
        <div className="container mx-auto px-20 max-w-[1400px] text-center space-y-32">
            ...
            <div className="space-y-12">
                ...
                <p className="text-2xl md:text-4xl opacity-50 font-light leading-relaxed max-w-6xl mx-auto tracking-tight text-center">
            ...
            <div className="flex flex-wrap justify-center gap-32 pt-10 opacity-60">
                {["POPIA Verified", "Bank Grade", "Localized Nodes", "Zero Trust"].map((tag, i) => (
                    <div key={i} className="flex items-center gap-6 group">
                        ...
                        <span className="text-[16px] font-black uppercase tracking-[0.6em] group-hover:opacity-100 transition-opacity text-current leading-none">{tag}</span>
                    </div>
                ))}
            </div>
        </div>
      ...
      <footer className={cn(
        ...
        theme === "dark" ? "bg-[#000000] border-white/5" : "bg-white border-black/5 shadow-2xl"
      )}>
        <div className="container mx-auto px-20">
            {/* Final CTA inside footer context */}
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-24 relative z-10 mx-auto w-full max-w-6xl">
                    ...
                    <div className="text-left group cursor-pointer flex flex-col gap-4 shrink-0">
                        ...
                        <div className="flex items-center gap-10 text-blue-600 group-hover:text-blue-500 transition-colors text-left leading-none">
                            ...
                            <ArrowRight className="h-16 w-16 transform group-hover:translate-x-10 transition-transform duration-500" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-48 mb-40 text-left pt-32 border-t border-current/5">
                <div className="space-y-16 text-left">
                    ...
                    <p className="text-xl opacity-30 leading-relaxed font-medium max-w-lg uppercase tracking-[0.2em] italic text-current">
            ...
            <div className="pt-20 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-16 opacity-20 text-[12px] font-black uppercase tracking-[1em] text-left leading-none text-current">
