...
export default function LandingAlt49() {
  ...
  return (
    <div className={cn(
      ...
      {/* Visual Background: Refined & Spacious */}
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className={cn(
            ...
            "bg-[radial-gradient(circle_at_center,currentColor_0.5px,transparent_0.5px)] bg-[size:40px_40px]"
        )} />
      </div>
      ...
      {/* Grid: High Density Impact - Spacious & Light Mode Friendly */}
      ...
      <section id="compliance" className={cn(
        ...
        <div className="container mx-auto px-10 max-w-[1400px] text-center space-y-32">
            <div className="flex justify-center">
                <div className="h-32 w-32 border-2 border-blue-600 flex items-center justify-center rounded-full transform hover:rotate-[225deg] transition-all duration-1000 cursor-pointer group shadow-2xl">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-40 mb-40 text-left pt-32 border-t border-current/5">
                <div className="space-y-16 text-left">
                    ...
                    <p className="text-lg opacity-30 leading-relaxed font-medium max-w-md uppercase tracking-[0.2em] italic text-current text-left">
                        The definitive orchestration standard for South African fintech lead systems. Decentralized. Autonomous. Hardened.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-32 text-left flex-1 text-current">
                    ...
                    <div className="space-y-12 text-left">
                        ...
                        <div className="flex gap-8 pt-2">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="h-10 w-10 border border-current opacity-10 rounded-lg flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all cursor-pointer shadow-xl">
