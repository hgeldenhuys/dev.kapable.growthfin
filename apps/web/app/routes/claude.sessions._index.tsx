...
export default function Sessions() {
	...
	// Filter sessions by projectId if selected
	const filteredSessions = selectedProjectId
		? Array.from(sessions.values()).filter((s) => s.projectId === selectedProjectId)
	...
	const sessionsList = filteredSessions.sort((a, b) => {
