...
export default function LandingAlt31() {
  ...
  return (
    <div className={cn(
      ...
      <nav className={cn(
        ...
        <div className="container mx-auto px-8 h-24 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="h-10 w-10 bg-blue-600 rounded-xl flex items-center justify-center shadow-[0_0_30px_rgba(37,99,235,0.3)] group-hover:scale-105 transition-transform duration-500">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link to="/auth/sign-up">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white rounded-none px-10 text-[10px] font-black uppercase tracking-[0.3em] h-11 shadow-2xl shadow-blue-600/20 transition-all">
                Initialize Node
              </Button>
            </Link>
          </div>
      ...
      {/* Hero Section: Centered & Architectural */}
      <section className="relative h-screen flex flex-col items-center justify-center px-8 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
              "mb-12 py-3 px-10 rounded-full font-black tracking-[0.5em] uppercase text-[10px] border transition-colors shrink-0",
              theme === "dark" ? "bg-blue-900/20 border-blue-500/20 text-blue-400" : "bg-blue-50 border-blue-100 text-blue-600"
            )}>
              Lead Orchestration for Silicon Cape Fintech // v4.2
            </Badge>
            
            <h1 className="text-6xl md:text-8xl lg:text-[10rem] xl:text-[12rem] font-black tracking-tighter mb-8 leading-[0.8] uppercase italic text-center shrink-0">
              <span className="block">Orchestrate</span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-400 to-emerald-500 inline-block not-italic pb-4">
                The Cape.
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-40 max-w-4xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              Agios AI provides the high-fidelity orchestration layer for South Africa's most aggressive lead generation engines. Built for the R1B+ ecosystem.
            </p>
      ...
      {/* Logic Showcase */}
      <section id="logic" className="py-52 px-12 relative overflow-hidden text-left shrink-0">
                ...
                <div className="flex-1 space-y-24">
                    <div className="space-y-10">
                        ...
                        <p className="text-xl md:text-3xl opacity-50 font-light leading-relaxed max-w-3xl tracking-tight">
                            Deploy specialized autonomous units trained on localized South African financial data. From prospecting to qualified conversion.
                        </p>
                    </div>
      ...
      <footer className={cn(
        ...
        <div className="container mx-auto px-12">
            {/* CTA Final */}
            <div className="py-48 text-center relative mb-40 flex flex-col items-center">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-40 mb-40 text-left pt-32 border-t border-current/5">
                <div className="space-y-16 text-left">
                    <div className="flex items-center gap-8 text-left">
                        <div className="h-14 w-14 bg-blue-600 rounded-3xl flex items-center justify-center shadow-2xl shadow-blue-600/20">
                    ...
                    <p className="text-xl opacity-30 leading-relaxed font-medium max-w-md uppercase tracking-[0.2em] italic">
                        The absolute orchestration standard for high-velocity Silicon Cape financial lead generation systems.
                    </p>
                </div>
