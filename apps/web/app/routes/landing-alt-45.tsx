...
export default function LandingAlt45() {
  ...
  return (
    <div className={cn(
      ...
      {/* Visual Background: Sophisticated & Spacious */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className={cn(
          "absolute top-[-10%] right-[-5%] w-[90%] h-[90%] blur-[250px] rounded-full transition-all duration-1000 opacity-20",
          theme === "dark" ? "bg-blue-600/30" : "bg-blue-400/40"
        )} />
        <div className={cn(
            "absolute inset-0 opacity-[0.02] dark:opacity-[0.05] pointer-events-none bg-[radial-gradient(circle_at_center,currentColor_1px,transparent_1px)] bg-[size:64px_64px]"
        )} />
      </div>
      ...
      <nav className={cn(
        ...
        theme === "dark" ? "border-white/5 bg-black/40 backdrop-blur-xl" : "border-black/5 bg-white/60 backdrop-blur-xl shadow-sm"
      )}>
        <div className="container mx-auto px-12 h-24 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-16 text-[10px] font-black uppercase tracking-[0.4em] opacity-60">
      ...
      {/* Hero Section: Engineered for Cinematic Spacing */}
      <section className="relative min-h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
              "mb-16 py-3 px-12 rounded-full font-black tracking-[0.4em] uppercase text-[10px] border-2 transition-colors shrink-0",
              theme === "dark" ? "bg-blue-950/20 border-blue-500/20 text-blue-400" : "bg-blue-50 border-blue-100 text-blue-600 shadow-sm"
            )}>
              Advanced Lead Orchestration // v4.5 // Cape Town
            </Badge>
            
            <h1 className="text-7xl md:text-9xl lg:text-[11rem] xl:text-[13rem] font-black tracking-tighter mb-10 leading-[0.8] uppercase italic shrink-0">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-40 max-w-4xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              Agios AI is the absolute standard for South Africa's highest-velocity lead generation pipelines. Autonomous, hardened, and infinitely scalable.
            </p>
        ...
        {/* Global Hub Status - Absolute Bottom with Margin */}
        <div className={cn(
      ...
      {/* Pipeline Grid: Spacious Performance Engine */}
      <section id="pipeline" className={cn(
        ...
        <div className="container mx-auto px-16 max-w-[1600px]">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-48 text-left">
                {[
                    { label: "Pipeline Value", value: "R3.4B+", icon: <TrendingUp className="h-10 w-10 text-blue-600" />, desc: "Monthly orchestrated volume." },
                    { label: "Lead Density", value: "125k+", icon: <Activity className="h-10 w-10 text-blue-500" />, desc: "Daily qualified population." },
                    { label: "Compliance Score", value: "100%", icon: <ShieldCheck className="h-10 w-10 text-emerald-500" />, desc: "POPIA regulatory index." },
                    { label: "Agent Population", value: "12.8M", icon: <Fingerprint className="h-10 w-10 text-blue-400" />, desc: "Active units on the grid." }
                ].map((stat, i) => (
                ...
                <div className="flex-1 space-y-28">
                    <div className="space-y-12">
                        ...
                        <p className="text-2xl md:text-3xl opacity-50 font-light leading-relaxed max-w-4xl tracking-tight">
                            Deploy specialized autonomous units trained on localized financial data. From prospecting to qualified conversion, we map the Silicon Cape in real-time.
                        </p>
                    </div>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                        {[
                            { title: "Market Sourcing", desc: "Autonomous agents scan market signals across 50M+ South African data points.", icon: <Globe className="h-8 w-8" /> },
                            ...
                            <div key={i} className="space-y-8 group text-left">
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-lg font-black uppercase tracking-widest text-blue-600 flex items-center gap-6 italic group-hover:text-blue-500 transition-colors leading-none">
      ...
      {/* Compliance: Regional standard - Hardened Baseline */}
      <section id="compliance" className={cn(
        ...
        <div className="container mx-auto px-10 max-w-6xl text-center space-y-32">
            <div className="flex justify-center">
                <div className="h-40 w-40 border-2 border-blue-600 flex items-center justify-center rounded-full transform hover:scale-110 transition-all duration-700 cursor-pointer group shadow-2xl">
            ...
            <div className="flex flex-wrap justify-center gap-32 pt-10 opacity-60">
                {["POPIA Verified", "Bank Grade", "Localized Nodes", "Zero Trust"].map((tag, i) => (
                    <div key={i} className="flex items-center gap-6 group">
                        <div className="h-3 w-3 rounded-full bg-blue-600 group-hover:scale-150 transition-transform shadow-[0_0_15px_rgba(37,99,235,1)]" />
        ...
        <div className="container mx-auto px-20">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-40 mb-40 text-left pt-32 border-t border-current/5">
                <div className="space-y-16 text-left">
                    ...
                    <p className="text-lg opacity-30 leading-relaxed font-medium max-w-md uppercase tracking-[0.2em] italic text-current">
