...
export default function LandingAlt41() {
    ...
    <div className={cn(
      ...
      <nav className={cn(
        ...
        <div className="container mx-auto px-10 h-24 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-16 text-[10px] font-black uppercase tracking-[0.4em] opacity-50">
            <a href="#performance" className="hover:text-blue-600 transition-colors">Performance</a>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
                "mb-12 py-3 px-10 rounded-full font-black tracking-[0.5em] uppercase text-[11px] border-2 transition-colors shrink-0",
                theme === "dark" ? "bg-blue-950/20 border-blue-500/20 text-blue-400" : "bg-blue-50 border-blue-100 text-blue-600 shadow-sm"
            )}>
                Lead Orchestration // Silicon Cape // v4.4
            </Badge>
            ...
            <p className="text-xl md:text-3xl lg:text-4xl opacity-40 max-w-5xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
                Agios AI is the absolute standard for South Africa's highest-velocity lead generation pipelines. Autonomous. Hardened. Infinite.
            </p>
        ...
        <div className="absolute bottom-16 left-0 w-full px-16 hidden lg:flex items-center justify-between opacity-30 text-[10px] font-black uppercase tracking-[0.6em] pointer-events-none">
      ...
      <section id="performance" className={cn(
          "py-64 border-y transition-colors shrink-0 relative z-10",
          theme === "dark" ? "bg-[#020617] border-white/5 shadow-[inset_0_0_150px_rgba(0,0,0,0.5)]" : "bg-[#f8fafc] border-slate-200 shadow-inner"
      )}>
        <div className="container mx-auto px-12 max-w-[1600px]">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-40 text-left">
                {[
                    { label: "Market Orchestrated", value: "R3.4B+", icon: <TrendingUp className="h-10 w-10 text-blue-600" /> },
                    ...
                    { label: "Active Units", value: "12.8M", icon: <Fingerprint className="h-10 w-10 text-blue-600" /> }
                ].map((stat, i) => (
            ...
            <div className="flex flex-col lg:flex-row items-center gap-52 text-left">
                <div className="flex-1 space-y-28">
                    <div className="space-y-12">
                        ...
                        <p className="text-xl md:text-3xl opacity-50 font-light leading-relaxed max-w-4xl tracking-tight">
      ...
      <section id="compliance" className={cn(
        ...
        <div className="container mx-auto px-12 max-w-[1400px] text-center space-y-32">
            <div className="flex justify-center">
                <div className="h-40 w-40 border-2 border-blue-600 flex items-center justify-center rounded-sm rotate-45 transform hover:rotate-[225deg] transition-all duration-1000 cursor-pointer group shadow-2xl">
            ...
            <div className="space-y-12">
                ...
                <p className="text-2xl md:text-4xl opacity-50 font-light leading-relaxed max-w-6xl mx-auto tracking-tight">
                    POPIA is our baseline. Every lead orchestrated by Agios is processed within a secure, localized South African environment.
                </p>
            </div>
      ...
      <footer className={cn(
        ...
        <div className="container mx-auto px-20">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-48 mb-40 text-left pt-32 border-t border-current/5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-32 text-left flex-1">
                    <div className="space-y-14 text-left">
                        <h4 className="text-[13px] font-black uppercase tracking-[0.6em] text-blue-600 text-left">Engine</h4>
            ...
            <div className="pt-24 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-20 opacity-20 text-[13px] font-black uppercase tracking-[1em] text-left leading-none">
