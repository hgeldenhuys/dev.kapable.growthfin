...
export default function LandingAlt57() {
  ...
  return (
    <div className={cn(
      ...
      {/* Background Decor: Atmospheric & Clean */}
      ...
      {/* Hero Section: Absolute Focus & Vertical Symmetry */}
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          <motion.div
            ...
            className="flex flex-col items-center max-w-7xl -mt-20 md:-mt-32"
          >
            <Badge className={cn(
              ...
              Advanced Lead Orchestration for Cape Fintech // v4.7.0
            </Badge>
            
            <h1 className="text-6xl md:text-8xl lg:text-[10rem] xl:text-[13rem] font-black tracking-tighter mb-10 leading-[0.8] uppercase italic shrink-0 text-center">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-40 max-w-5xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0 text-center text-current">
              Agios AI is the absolute standard for South Africa's highest-velocity lead generation pipelines. Autonomous, hardened, and localized.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-4xl shrink-0">
              ...
              <div className="text-left group cursor-pointer flex flex-col gap-2 shrink-0">
                <div className="text-[11px] font-black uppercase tracking-[0.4em] opacity-40 leading-none text-current">System Access</div>
      ...
      {/* Grid: Metrics in Rand - Spacious Editorial Design */}
      <section id="pipeline" className={cn(
        ...
        <div className="container mx-auto px-16 max-w-[1600px]">
            <div className="max-w-4xl text-left mb-64 space-y-6 px-4">
                ...
                <h2 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-none text-current">The Rand Engine.</h2>
                <p className="text-2xl md:text-3xl opacity-40 font-light max-w-2xl leading-relaxed tracking-tight text-left">High-fidelity lead qualification at absolute scale.</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-52 text-left">
                <div className="flex-1 space-y-28 text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-24 text-left">
                        {[
                            { title: "Market Sourcing", desc: "Autonomous agents scan the digital landscape for real-time intent signals across 50M+ data points.", icon: <Globe className="h-8 w-8 text-blue-600" /> },
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness and FSR credit data models.", icon: <Fingerprint className="h-8 w-8 text-blue-600" /> },
                        ].map((item, i) => (
                            <div key={i} className="space-y-8 group text-left">
                                ...
                                <div className="space-y-4 text-left">
                                    ...
                                    <p className="text-lg opacity-40 font-light leading-relaxed text-left">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
      ...
      <section id="compliance" className={cn(
          "py-72 border-y transition-colors shrink-0 relative",
        ...
        <div className="container mx-auto px-10 max-w-[1400px] text-center space-y-32 text-left md:text-center">
            ...
            <div className="space-y-12 text-left md:text-center">
                <h2 className="text-7xl md:text-[10rem] font-black uppercase tracking-tighter italic leading-[0.8] text-center text-current leading-tight">Hardened <br /> Regional Compliance.</h2>
            ...
            <div className="py-80 text-center relative mb-48 flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-24 relative z-10 mx-auto w-full max-w-6xl">
                    <Link to="/auth/sign-up" className="w-full sm:w-auto flex-1">
                        <Button size="lg" className="h-32 px-24 text-[18px] font-black uppercase tracking-[0.8em] bg-blue-600 hover:bg-blue-700 text-white rounded-none shadow-[0_60px_150px_rgba(37,99,235,0.7)] w-full transform hover:scale-105 transition-all leading-none">
                            Initialize Node
                        </Button>
                    </Link>
                    <div className="text-left group cursor-pointer flex flex-col gap-4 shrink-0">
                        ...
                        <div className="flex items-center gap-10 text-blue-600 group-hover:text-blue-500 transition-colors text-left leading-none text-left">
                            ...
                            <ArrowRight className="h-12 w-12 transform group-hover:translate-x-6 transition-transform duration-500" />
                        </div>
                    </div>
                </div>
            </div>

            <div className="flex flex-col lg:flex-row items-start justify-between gap-48 mb-40 text-left pt-40 border-t border-current/5">
