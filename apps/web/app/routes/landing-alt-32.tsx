...
export default function LandingAlt32() {
  ...
  return (
    <div className={cn(
      ...
      {/* Visual Background: Refined and Subtle */}
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className={cn(
            "absolute inset-0 opacity-[0.03] dark:opacity-[0.08] pointer-events-none",
      ...
      <nav className={cn(
        ...
        theme === "dark" ? "border-white/5 bg-slate-950/50 backdrop-blur-xl" : "border-slate-200 bg-white/70 backdrop-blur-xl"
      )}>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
              ...
              Lead Orchestration for Silicon Cape Fintech // v4.2.1
            </Badge>
        ...
        {/* Tactical Hub Status Line - Refined for Light Mode and Positioning */}
        <div className={cn(
      ...
      {/* Grid: High Density Impact - More whitespace, better light mode contrast */}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-48 text-left">
                ...
                <div className="w-full lg:w-[45%] relative shrink-0">
                    <div className={cn(
                        ...
                        theme === "dark" ? "border-white/10 bg-black shadow-[0_0_150px_rgba(37,99,235,0.1)]" : "border-slate-200 bg-white shadow-3xl shadow-black/5"
                    )}>
        ...
        <div className="container mx-auto px-20">
            ...
            <div className="py-64 text-center relative mb-40 flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-20 relative z-10 mx-auto w-full max-w-5xl">
                    <Link to="/auth/sign-up" className="w-full sm:w-auto flex-1">
                        <Button size="lg" className="h-32 px-24 text-[18px] font-black uppercase tracking-[0.6em] bg-blue-600 hover:bg-blue-700 text-white rounded-none shadow-[0_40px_150px_rgba(37,99,235,0.7)] w-full">
                            Initialize Node
                        </Button>
                    </Link>
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-40 mb-40 text-left pt-32 border-t border-current/5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-32 text-left flex-1">
                    ...
                    <div className="space-y-12 text-left">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.6em] text-blue-600">Compliance</h4>
                        <ul className="space-y-8 text-[11px] font-bold uppercase tracking-widest opacity-40">
                    ...
                    <div className="space-y-12 text-left">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.6em] text-blue-600">Regional</h4>
                        <ul className="space-y-8 text-[11px] font-bold uppercase tracking-widest opacity-40">
                            <li><a href="#" className="hover:opacity-100 transition-opacity">Silicon Cape</a></li>
                            <li><a href="#" className="hover:opacity-100 transition-opacity">HQ Status</a></li>
                        </ul>
                    </div>
                    <div className="space-y-12 text-left">
            ...
            <div className="pt-20 border-t border-current/5 flex flex-col md:flex-row items-center justify-between gap-16 opacity-20 text-[12px] font-black uppercase tracking-[0.8em] text-left">
