...
export default function LandingAlt39() {
  ...
  return (
    <div className={cn(
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className={cn(
            "absolute inset-0 opacity-[0.02] dark:opacity-[0.06] pointer-events-none bg-[url('https://grainy-gradients.vercel.app/noise.svg')]"
        )} />
      </div>
      ...
      <nav className={cn(
        ...
        theme === "dark" ? "bg-black/20 backdrop-blur-md border-b border-white/5" : "bg-white/20 backdrop-blur-md border-b border-black/5"
      )}>
        <div className="container mx-auto px-10 h-24 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="h-10 w-10 bg-blue-600 rounded-xl flex items-center justify-center shadow-2xl shadow-blue-600/30">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
                ...
                Advanced Lead Orchestration // v4.6 // silicon cape
            </Badge>
            ...
            <p className="text-xl md:text-3xl opacity-40 max-w-5xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0 text-center">
                The absolute high-fidelity orchestration layer for South Africa's highest-velocity financial lead generation pipelines. 
            </p>
        ...
        <div className={cn(
            "absolute bottom-16 left-0 w-full px-16 hidden lg:flex items-center justify-between font-black uppercase tracking-[0.6em] pointer-events-none opacity-30",
            theme === "dark" ? "text-white" : "text-slate-900"
        )}>
            <div className="flex items-center gap-10">
                <div className="flex items-center gap-4 text-left">
                    <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                    <span>NODE_CAPE_TOWN_01 // SYNCHRONIZED</span>
                </div>
      ...
      {/* Grid: High Density Impact */}
      <section id="pipeline" className={cn(
          "py-60 border-y transition-colors shrink-0 relative z-10",
        ...
        <div className="container mx-auto px-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-40 text-left">
                {[
                    ...
                    { label: "Daily leads qualified", value: "85k+", icon: <Zap className="h-8 w-8 text-amber-500" /> },
                    ...
                    <div key={i} className="flex flex-col gap-10 text-left group">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-[0.4em] opacity-40 mt-2 leading-none">{stat.label}</span>
                        </div>
                    </div>
                ))}
            </div>
      ...
      {/* Agents Section */}
      <section id="logic" className="py-64 px-10 relative overflow-hidden text-left shrink-0">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-48 text-left">
                <div className="flex-1 space-y-20">
                    <div className="space-y-8">
                        ...
                        <p className="text-xl md:text-2xl opacity-50 font-light leading-relaxed max-w-2xl">
                            Deploy specialized autonomous units trained on localized financial data. We map the entire Silicon Cape economy in real-time.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        {[
                            ...
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness data.", icon: <Cpu className="h-8 w-8 text-blue-500" /> },
                        ].map((item, i) => (
                ...
                <div className="w-full lg:w-[45%] relative shrink-0">
                    <div className={cn(
                        ...
                        theme === "dark" ? "border-white/10 bg-black shadow-[0_0_150px_rgba(37,99,235,0.1)]" : "border-black/5 bg-white shadow-black/5"
                    )}>
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center">
                            ...
                            <div className="text-center space-y-6 relative">
                                <div className="text-5xl lg:text-7xl font-black italic uppercase tracking-tighter leading-none text-current opacity-10 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap pointer-events-none select-none leading-none">
                                    AGIOS OS
                                </div>
      ...
      <section id="compliance" className={cn(
          "py-64 border-y transition-colors shrink-0",
            ...
            <div className="flex flex-wrap justify-center gap-24 pt-10 opacity-60">
                {["POPIA Verified", "Bank Grade", "Localized Nodes", "Zero Trust"].map((tag, i) => (
                    <div key={i} className="flex items-center gap-6 group">
                        ...
                        <span className="text-[14px] font-black uppercase tracking-[0.6em] group-hover:opacity-100 transition-opacity leading-none text-current">{tag}</span>
                    </div>
                ))}
            </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-40 mb-40">
                <div className="space-y-16">
                    <div className="flex items-center gap-6">
                        <div className="h-10 w-10 bg-blue-600 rounded-xl flex items-center justify-center shadow-2xl shadow-blue-600/20">
                            <Mountain className="h-6 w-6 text-white" />
                        </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-32 flex-1 text-current">
                    <div className="space-y-12">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.5em] text-blue-600">System</h4>
                    ...
                    <div className="space-y-12">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.5em] text-blue-600">Legal</h4>
                        <ul className="space-y-8 text-[11px] font-bold uppercase tracking-widest opacity-40">
                    ...
                    <div className="space-y-12">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.5em] text-blue-600">HQ</h4>
                        <ul className="space-y-8 text-[11px] font-bold uppercase tracking-widest opacity-40">
                    ...
                    <div className="space-y-12">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.5em] text-blue-600">Network</h4>
