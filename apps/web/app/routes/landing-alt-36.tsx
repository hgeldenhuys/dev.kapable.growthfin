...
export default function LandingAlt36() {
  ...
  return (
    <div className={cn(
      ...
      {/* Background Decor: Clean and High-End */}
        ...
        <div className="container mx-auto px-10 h-24 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer text-left">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[7px] font-bold uppercase tracking-[0.5em] opacity-40 mt-1 leading-none">Silicon Cape // HQ</span>
            </div>
          </div>
          
          <div className="hidden lg:flex items-center gap-12 text-[10px] font-black uppercase tracking-[0.4em] opacity-50">
            <a href="#engine" className="hover:text-blue-600 transition-colors">The Engine</a>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl lg:text-[11rem] font-black tracking-tighter mb-10 leading-[0.8] uppercase italic shrink-0">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-400 to-indigo-700 inline-block not-italic pb-4 leading-none text-left md:text-center">
                Cape Growth.
              </span>
            </h1>
        ...
        {/* Tactical Hub Status Line - Pushed to absolute bottom corners */}
        <div className={cn(
      ...
      <section id="engine" className={cn(
          ...
          theme === "dark" ? "bg-[#020617] border-white/5 shadow-[inset_0_0_100px_rgba(0,0,0,0.5)]" : "bg-white border-slate-200 shadow-inner"
      )}>
        <div className="container mx-auto px-12">
            <div className="max-w-4xl text-left mb-40 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-32 lg:gap-48 text-left">
                {[
                    { label: "Market Orchestrated", value: "R3.4B+", icon: <TrendingUp className="h-8 w-8 text-blue-600" />, desc: "Monthly pipeline volume" },
                    { label: "Daily leads qualified", value: "125k+", icon: <Target className="h-8 w-8 text-blue-500" />, desc: "High-density throughput" },
                    { label: "Compliance Score", value: "100%", icon: <ShieldCheck className="h-8 w-8 text-emerald-500" />, desc: "Regulatory verification" },
                    { label: "Qualification Speed", value: "85ms", icon: <Zap className="h-8 w-8 text-amber-500" />, desc: "Mean qualification time" }
                ].map((stat, i) => (
            ...
            <div className="flex flex-col lg:flex-row items-center gap-48 text-left">
                <div className="flex-1 space-y-24">
                    <div className="space-y-10">
                        <Badge className="bg-blue-600 text-white rounded-none px-6 py-2 font-black text-[11px] uppercase tracking-[0.6em]">Agent Logistics</Badge>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                        {[
                            { title: "Market Sourcing", desc: "Autonomous agents scan the digital landscape for real-time intent signals across 50M+ data points.", icon: <Globe className="h-6 w-6 text-blue-600" /> },
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness and credit scoring.", icon: <BarChart3 className="h-6 w-6 text-blue-500" /> },
                        ].map((item, i) => (
      ...
      <section id="compliance" className={cn(
        ...
        <div className="container mx-auto px-10 max-w-6xl text-center space-y-32">
            <div className="flex justify-center">
                <div className="h-32 w-32 border-2 border-blue-600 flex items-center justify-center rounded-sm rotate-45 transform hover:scale-110 transition-all duration-1000 cursor-pointer group shadow-2xl">
            ...
            <div className="flex flex-col lg:flex-row items-start justify-between gap-40 mb-40 text-left pt-32 border-t border-current/5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-32 text-left flex-1">
                    <div className="space-y-12 text-left">
                        <h4 className="text-[12px] font-black uppercase tracking-[0.6em] text-blue-600 text-left">Engine</h4>
