...
export default function LandingAlt28() {
  ...
  return (
    <div className={cn(
      "min-h-screen transition-colors duration-1000 font-sans selection:bg-blue-600/30 overflow-x-hidden text-left flex flex-col justify-between",
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className={cn(
            ...
            "bg-[radial-gradient(circle_at_center,currentColor_1px,transparent_1px)] bg-[size:60px:60px]"
        )} />
      </div>
      ...
      <header className="fixed top-0 w-full z-50 px-10 h-32 flex items-center">
        <div className="container mx-auto flex items-center justify-between">
            <div className="flex items-center gap-6 group cursor-pointer text-left">
                <div className="h-12 w-12 bg-blue-600 rounded-2xl flex items-center justify-center shadow-[0_0_50px_rgba(37,99,235,0.4)] group-hover:scale-110 transition-transform duration-500">
                    <Mountain className="h-6 w-6 text-white" />
                </div>
                <div className="flex flex-col">
                    <span className="text-3xl font-black tracking-tighter leading-none uppercase italic">Agios<span className="text-blue-600">.</span>OS</span>
                    <span className="text-[10px] font-black uppercase tracking-[0.5em] opacity-40 mt-1">Silicon Cape // HQ</span>
                </div>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-16 text-[11px] font-black uppercase tracking-[0.4em] opacity-50">
                ...
                <a href="#security" className="hover:text-blue-600 transition-colors">POPIA Hardening</a>
            </div>
            ...
            <div className="flex items-center gap-10">
                ...
                <Link to="/auth/sign-in" className="text-[11px] font-black uppercase tracking-[0.4em] opacity-40 hover:opacity-100 transition-opacity">Login</Link>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center">
            ...
            >
                <Badge className={cn(
                    "mb-12 py-3 px-10 rounded-full font-black tracking-[0.5em] uppercase text-[11px] border-2 transition-colors",
                    theme === "dark" ? "bg-blue-950/20 border-blue-500/20 text-blue-400" : "bg-blue-50 border-blue-100 text-blue-600"
                )}>
                    Advanced Lead Orchestration // v4.1.2 // silicon cape
                </Badge>
                
                <h1 className="text-7xl md:text-9xl lg:text-[14rem] font-black tracking-tighter mb-10 leading-[0.75] uppercase italic text-center shrink-0">
                ...
                <p className="text-xl md:text-3xl lg:text-4xl opacity-40 max-w-5xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
                    Agios AI powers the highest-velocity financial lead generation pipelines in South Africa. Autonomous. Hardened. Absolute.
                </p>
      ...
      <section id="security" className={cn(
        ...
        <div className="container mx-auto px-10 max-w-6xl text-center space-y-24">
            ...
            <div className="space-y-10">
                <h2 className="text-7xl md:text-9xl font-black uppercase tracking-tighter italic leading-[0.8]">Hardened <br /> Local Compliance.</h2>
      ...
      <footer className={cn(
        ...
        <div className="container mx-auto px-20">
            {/* Final CTA inside footer context for flow */}
            <div className="py-48 text-center relative mb-32">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-20 relative z-10">
                    <Link to="/auth/sign-up" className="w-full sm:w-auto">
                        <Button size="lg" className="h-28 px-24 text-[18px] font-black uppercase tracking-[0.6em] bg-blue-600 hover:bg-blue-700 text-white rounded-none shadow-[0_60px_150px_rgba(37,99,235,0.7)] w-full">
                            Initialize Node
                        </Button>
                    </Link>
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-40 mb-40 text-left pt-32 border-t border-current/5">
