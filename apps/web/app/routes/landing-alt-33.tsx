...
export default function LandingAlt34() {
  ...
  return (
    <div className={cn(
      ...
      theme === "dark" ? "bg-[#050505] text-slate-200" : "bg-[#ffffff] text-slate-900"
    )}>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className={cn(
            "absolute inset-0 opacity-[0.02] dark:opacity-[0.05] pointer-events-none bg-[url('https://grainy-gradients.vercel.app/noise.svg')]"
        )} />
      </div>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
              ...
              Advanced Lead Orchestration // v4.2.3 // Silicon Cape
            </Badge>
            ...
            <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-black tracking-tighter mb-10 leading-[0.85] uppercase italic shrink-0">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-700 inline-block not-italic pb-4 leading-none">
                Cape Growth.
              </span>
            </h1>

            <p className="text-lg md:text-2xl opacity-50 max-w-4xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              The absolute orchestration layer for South Africa's most aggressive financial lead engines. Built for the R100M+ environment. Autonomous. Absolute.
            </p>
            
            <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-4xl shrink-0">
              <Button size="lg" className="h-24 px-20 text-[14px] font-black uppercase tracking-[0.5em] bg-blue-600 hover:bg-blue-700 text-white rounded-none shadow-[0_30px_80px_rgba(37,99,235,0.45)] flex-1 transform hover:scale-105 transition-all">
                Initialize System
              </Button>
        ...
        {/* Global Hub Status Line - Pushed to absolute bottom corners to avoid overlap */}
        <div className={cn(
      ...
      <section id="pipeline" className={cn(
        ...
        <div className="container mx-auto px-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-40">
                {[
                    { label: "Market Value", value: "R3.4B+", icon: <TrendingUp className="h-8 w-8 text-blue-600" /> },
                    { label: "Daily leads", value: "125k+", icon: <Zap className="h-8 w-8 text-amber-500" /> },
                ...
                <div className="flex-1 space-y-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                        {[
                            ...
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness and credit scoring data." },
                        ].map((item, i) => (
      ...
      {/* Security Section: POPIA Hardening */}
      <section id="security" className={cn(
          "py-60 border-y transition-colors shrink-0",
        ...
        <div className="container mx-auto px-10 max-w-6xl text-center space-y-32">
            ...
            <div className="space-y-12">
                ...
                <p className="text-2xl md:text-4xl opacity-50 font-light leading-relaxed max-w-6xl mx-auto tracking-tight">
                    POPIA is our baseline. Every lead orchestrated by Agios is processed within a secure, localized South African data environment, meeting the highest standards of security.
                </p>
            </div>
            <div className="flex flex-wrap justify-center gap-24 pt-10 opacity-60">
                {["POPIA Verified", "Bank Grade", "Localized Nodes", "Zero Trust"].map((tag, i) => (
                    <div key={i} className="flex items-center gap-6 group">
                        ...
                        <span className="text-[14px] font-black uppercase tracking-[0.6em] group-hover:opacity-100 transition-opacity">{tag}</span>
                    </div>
                ))}
            </div>
        </div>
      ...
      <footer className={cn(
        ...
        <div className="container mx-auto px-20">
            {/* CTA Final */}
            <div className="py-64 text-center relative mb-40 flex flex-col items-center">
