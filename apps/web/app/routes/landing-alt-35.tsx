...
export default function LandingAlt35() {
  ...
  return (
    <div className={cn(
      ...
      {/* Background Decor: Ultimate Sophistication */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className={cn(
          "absolute top-[-10%] left-[-10%] w-[100%] h-[100%] blur-[200px] rounded-full transition-all duration-1000 opacity-20",
        ...
        <div className="container mx-auto px-10 h-24 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[7px] font-bold uppercase tracking-[0.6em] opacity-40 mt-1">Silicon Cape // CPT</span>
            </div>
          </div>
      ...
      {/* Hero Section: Perfectly Centered Editorial */}
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center max-w-7xl">
          <motion.div
          ...
          >
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-40 max-w-5xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              Agios AI is the absolute orchestration standard for South Africa's highest-velocity financial lead pipelines. Built for the R100M+ environment.
            </p>
      ...
      {/* Grid: High Density Impact - Improved spacing */}
      <section id="pipeline" className={cn(
          "py-72 border-y transition-colors shrink-0 relative z-10",
          theme === "dark" ? "bg-[#020617] border-white/5" : "bg-[#f8fafc] border-slate-200 shadow-inner"
      )}>
        <div className="container mx-auto px-10">
            <div className="max-w-4xl text-left mb-32 space-y-4">
                ...
                <h2 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-none">The Rand Engine.</h2>
                <p className="text-xl opacity-40 font-light max-w-xl">Unmatched lead qualification velocity at industrial scale.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-32 text-left">
                {[
                    { label: "Monthly Orchestrated", value: "R3.4B+", icon: <TrendingUp className="h-8 w-8 text-blue-600" /> },
                    { label: "Daily Lead Population", value: "125k+", icon: <Zap className="h-8 w-8 text-amber-500" /> },
                    { label: "Qualification Speed", value: "85ms", icon: <Activity className="h-8 w-8 text-emerald-500" /> }
                ].map((stat, i) => (
                    <div key={i} className="flex flex-col gap-12 text-left group">
                        <div className="opacity-40 transform group-hover:scale-110 transition-transform duration-500">{stat.icon}</div>
                        <div className="flex flex-col gap-6">
                            <span className="text-6xl md:text-7xl lg:text-9xl font-black tracking-tighter italic leading-none">{stat.value}</span>
                            <span className="text-[12px] font-black uppercase tracking-[0.5em] opacity-40 mt-2 leading-none">{stat.label}</span>
                        </div>
                    </div>
                ))}
            </div>
      ...
      {/* Logic showcase */}
      <section id="logic" className="py-72 px-10 relative overflow-hidden text-left shrink-0">
