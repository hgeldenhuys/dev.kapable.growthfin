...
export default function LandingAlt47() {
  ...
  return (
    <div className={cn(
      ...
      {/* Visual Background Decor: Minimalist & Clean */}
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className={cn(
            "absolute inset-0 opacity-[0.01] dark:opacity-[0.03] pointer-events-none bg-[radial-gradient(circle_at_center,currentColor_1px,transparent_1px)] bg-[size:40px_40px]"
        )} />
      </div>
        ...
        <div className="container mx-auto px-10 h-24 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer text-left">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-black tracking-tighter leading-none uppercase italic text-current">Agios<span className="text-blue-600">.</span>OS</span>
              <span className="text-[7px] font-bold uppercase tracking-[0.4em] opacity-40 mt-1 leading-none">Silicon Cape // HQ</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-8">
            <button onClick={toggleTheme} className="h-9 w-9 rounded-full flex items-center justify-center hover:bg-blue-600/10 transition-colors border border-current/10">
      ...
      {/* Hero Section: Centered & High Focus */}
        ...
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
              ...
              Lead Orchestration for Silicon Cape Fintech // v4.3.2
            </Badge>
            ...
            <h1 className="text-6xl md:text-8xl lg:text-[11rem] font-black tracking-tighter mb-10 leading-[0.8] uppercase italic shrink-0">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-700 inline-block not-italic pb-4 leading-none text-left md:text-center">
                Cape Growth.
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-40 max-w-4xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              The definitive orchestration layer for South Africa's most aggressive financial lead generation pipelines. Autonomous, hardened, and localized.
            </p>
      ...
      {/* Grid: High Density Impact - Improved spacing and light mode friendly */}
      <section id="pipeline" className={cn(
          "py-72 border-y transition-colors shrink-0 relative z-10",
          theme === "dark" ? "bg-[#020617] border-white/5 shadow-[inset_0_0_100px_rgba(0,0,0,0.5)]" : "bg-[#f8fafc] border-slate-200 shadow-inner"
      )}>
        <div className="container mx-auto px-12">
            <div className="max-w-4xl text-left mb-48 space-y-4 px-4">
                <Badge className="bg-blue-600 text-white rounded-none px-6 py-1 font-black text-[10px] uppercase tracking-[0.5em]">Network Output</Badge>
                <h2 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-none text-current">The Pipeline Engine.</h2>
                <p className="text-2xl opacity-40 font-light max-w-2xl leading-relaxed">High-fidelity lead qualification at industrial scale.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-64 gap-y-48 text-left px-4">
                {[
                    { label: "Market Orchestrated", value: "R3.4B+", icon: <TrendingUp className="h-10 w-10 text-blue-600" />, desc: "Total monthly pipeline volume processed across the CPT node cluster." },
                    { label: "Daily Lead Population", value: "125k+", icon: <Zap className="h-10 w-10 text-amber-500" />, desc: "Total qualified leads distributed to closing nodes every 24h." },
                    { label: "Qualification Speed", value: "85ms", icon: <Activity className="h-10 w-10 text-emerald-500" />, desc: "Average time for an agent unit to qualify a prospect using neural scoring." }
                ].map((stat, i) => (
                    <div key={i} className="flex flex-col gap-12 text-left group py-4">
                        <div className="flex flex-col gap-10">
                            ...
                            <div className="space-y-6">
                                <span className="text-7xl md:text-8xl lg:text-[7.5rem] font-black tracking-tighter italic leading-none text-current transition-colors group-hover:text-blue-600">{stat.value}</span>
                                <div className="space-y-3 pt-6 border-t border-current/10 max-w-xs">
                                    <span className="text-[12px] font-black uppercase tracking-[0.4em] opacity-40 leading-none block text-left">{stat.label}</span>
                                    <p className="text-sm opacity-30 font-medium leading-relaxed max-w-xs text-left">{stat.desc}</p>
                                </div>
                            </div>
                        </div>
                    </div>
      ...
      <section id="logic" className="py-72 px-12 relative overflow-hidden text-left shrink-0">
        <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-48 text-left">
                <div className="flex-1 space-y-24 text-left">
                    <div className="space-y-10 text-left">
                        ...
                        <h2 className="text-6xl md:text-8xl lg:text-[10rem] font-black uppercase tracking-tighter leading-none italic text-current text-left">
                            Elite Unit <br /> <span className="text-blue-600 not-italic">Distribution.</span>
                        </h2>
                        <p className="text-xl md:text-3xl opacity-50 font-light leading-relaxed max-w-3xl tracking-tight text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20 text-left">
                        {[
                            { title: "Market Sourcing", desc: "Autonomous agents scan the digital landscape for real-time intent signals across 50M+ data points.", icon: <Globe className="h-6 w-6" /> },
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness and credit scoring.", icon: <BarChart3 className="h-6 w-6" /> },
                        ].map((item, i) => (
                            <div key={i} className="space-y-6 group text-left">
                                <div className="text-blue-600 opacity-60 group-hover:opacity-100 transform group-hover:scale-110 transition-all duration-500">{item.icon}</div>
                    ...
                    <div className={cn(
                        ...
                        <div className="flex items-center justify-between border-t border-current/10 pt-10">
                            ...
                            <div className="flex flex-col gap-2 text-right">
                                ...
                                <span className="text-3xl font-black italic leading-none uppercase text-current">CPT // HQ</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="container mx-auto px-10 max-w-[1400px] text-center space-y-32">
            <div className="flex justify-center">
                <div className="h-32 w-32 border-2 border-blue-600 flex items-center justify-center rounded-sm rotate-45 transform hover:rotate-[225deg] transition-all duration-1000 cursor-pointer group shadow-2xl">
                    <ShieldCheck className="h-14 w-14 text-blue-600 -rotate-45 group-hover:scale-110 transition-transform" />
                </div>
            </div>
            <div className="space-y-12">
                <h2 className="text-7xl md:text-[10rem] font-black uppercase tracking-tighter italic leading-[0.8] text-center text-current">Hardened <br /> Compliance.</h2>
