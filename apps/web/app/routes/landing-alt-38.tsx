...
export default function LandingAlt38() {
  ...
  return (
    <div className={cn(
      ...
      theme === "dark" ? "bg-[#030712] text-slate-200" : "bg-[#ffffff] text-slate-900"
    )}>
      {/* Background Decor: Cinematic & Depth */}
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className={cn(
            "absolute inset-0 opacity-[0.03] dark:opacity-[0.05] pointer-events-none bg-[radial-gradient(circle_at_center,currentColor_1px,transparent_1px)] bg-[size:48px_48px]"
        )} />
      </div>
      ...
      <nav className="fixed top-8 left-0 w-full z-50 px-10">
        <div className={cn(
            ...
            theme === "dark" ? "bg-black/60 border-white/10 shadow-2xl" : "bg-white/70 border-slate-200 shadow-lg shadow-black/5"
        )}>
          <div className="flex items-center gap-4 group cursor-pointer">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-black tracking-tight leading-none uppercase italic">Agios<span className="text-blue-600">.</span>Prime</span>
          ...
          <div className="flex items-center gap-8">
            ...
            <Link to="/auth/sign-up">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white rounded-none px-10 text-[10px] font-black uppercase tracking-[0.3em] h-10 shadow-2xl shadow-blue-600/20">
                Deploy Node
              </Button>
            </Link>
          </div>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          ...
          >
            <Badge className={cn(
              ...
              Lead Orchestration for Global Fintech // CPT // v4.3
            </Badge>
            
            <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-black tracking-tighter mb-10 leading-[0.85] uppercase italic shrink-0">
              <span className="block text-current">Powering</span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-400 to-indigo-600 not-italic pb-4 inline-block">
                Cape Growth.
              </span>
            </h1>
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-40 max-w-4xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              Agios AI is the high-fidelity orchestration layer powering South Africa's most aggressive financial lead pipelines. Built for the R100M+ environment.
            </p>
            
            <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-4xl shrink-0">
              <Button size="lg" className="h-24 px-20 text-[14px] font-black uppercase tracking-[0.5em] bg-blue-600 hover:bg-blue-700 text-white rounded-none shadow-[0_40px_100px_rgba(37,99,235,0.4)] flex-1 transform hover:scale-105 transition-all">
                Initialize System
              </Button>
              <div className="text-left group cursor-pointer flex items-center gap-8 opacity-60 hover:opacity-100 transition-opacity">
        ...
        {/* Tactical Hub Status Line - Refined positioning */}
        <div className={cn(
      ...
      {/* Grid: Rand-Denominated Performance - High Contrast & Whitespace */}
      <section id="pipeline" className={cn(
          "py-72 border-y transition-colors shrink-0 relative z-10",
          theme === "dark" ? "bg-[#020617] border-white/5 shadow-[inset_0_0_150px_rgba(0,0,0,0.4)]" : "bg-[#fcfcfc] border-slate-200 shadow-inner"
      )}>
        <div className="container mx-auto px-16 max-w-[1600px]">
            <div className="max-w-4xl text-left mb-48 space-y-4">
                ...
                <h2 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-none">The Pipeline Engine.</h2>
                <p className="text-2xl opacity-40 font-light max-w-2xl leading-relaxed">Industrial-strength qualification at absolute scale.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-52 gap-y-40 text-left">
                {[
                    { label: "Market Orchestrated", value: "R3.4B+", icon: <TrendingUp className="h-10 w-10 text-blue-600" />, desc: "Monthly pipeline volume processed across the CPT node cluster." },
                    ...
                    <div key={i} className="flex flex-col gap-12 text-left group">
                        <div className="flex flex-col gap-10">
                            <div className="h-20 w-20 border border-current/10 flex items-center justify-center rounded-full opacity-60 transform group-hover:rotate-12 transition-all duration-700 bg-current/[0.02]">
                                {stat.icon}
                            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-52 text-left">
                <div className="flex-1 space-y-28">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
                        {[
                            { title: "Market Discovery", desc: "Autonomous agents monitor intent signals across 50M+ South African data points.", icon: <Globe className="h-8 w-8" /> },
                            { title: "Neural Logic", desc: "Proprietary qualification models built on localized financial readiness datasets.", icon: <Cpu className="h-8 w-8" /> },
                        ].map((item, i) => (
      ...
      <section id="compliance" className={cn(
          ...
          theme === "dark" ? "bg-white/[0.01]" : "bg-slate-100/50 shadow-inner"
      )}>
        <div className="container mx-auto px-16 max-w-[1400px] text-center space-y-32">
            <div className="flex justify-center">
                <div className="h-32 w-32 border-2 border-blue-600 flex items-center justify-center rounded-full transform hover:rotate-[90deg] transition-all duration-1000 cursor-pointer group shadow-2xl bg-current/[0.02]">
            ...
            <div className="py-64 text-center relative mb-48 flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-24 relative z-10 mx-auto w-full max-w-6xl">
                    <Link to="/auth/sign-up" className="w-full sm:w-auto flex-1">
                        <Button size="lg" className="h-32 px-24 text-[18px] font-black uppercase tracking-[0.6em] bg-blue-600 hover:bg-blue-700 text-white rounded-none shadow-[0_60px_150px_rgba(37,99,235,0.8)] w-full transform hover:scale-105 transition-all">
                            Initialize Node
                        </Button>
                    </Link>
