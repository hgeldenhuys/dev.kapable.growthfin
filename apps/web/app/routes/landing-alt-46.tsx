...
export default function LandingAlt46() {
    ...
    <div className={cn(
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className={cn(
          ...
          theme === "dark" ? "bg-blue-600/40" : "bg-blue-300/40"
        )} />
        <div className={cn(
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full">
          <motion.div
            ...
            className="flex flex-col items-center max-w-7xl -mt-20"
          >
            <Badge className={cn(
            ...
            <p className="text-xl md:text-2xl lg:text-3xl opacity-40 max-w-4xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0">
              Agios AI provides the high-fidelity orchestration layer for South Africa's most aggressive financial lead generation engines. Built for the R100M+ environment.
            </p>
        ...
        {/* Global Hub Status Line - Pushed to absolute bottom corners */}
        <div className={cn(
        ...
        <div className="container mx-auto px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-32 lg:gap-48 text-left">
                {[
                    ...
                    { label: "Active Units", value: "12.8M", icon: <Fingerprint className="h-8 w-8 text-blue-400" />, desc: "Agent population" }
                ].map((stat, i) => (
                    <div key={i} className="flex flex-col gap-14 text-left group py-4">
                        <div className="opacity-60 transform group-hover:scale-110 transition-transform duration-500">{stat.icon}</div>
                        <div className="flex flex-col gap-6">
                            <span className="text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter italic leading-none transition-colors group-hover:text-blue-600">{stat.value}</span>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-48 text-left">
                <div className="flex-1 space-y-24">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                        {[
                            { title: "Market Sourcing", desc: "Autonomous agents scan the digital landscape for real-time intent signals across 50M+ data points.", icon: <Activity className="h-6 w-6 text-blue-600" /> },
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness and FSR data models.", icon: <BarChart3 className="h-6 w-6 text-blue-500" /> },
                        ].map((item, i) => (
                            <div key={i} className="space-y-8 group text-left">
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-lg font-black uppercase tracking-widest text-blue-600 flex items-center gap-6 italic group-hover:text-blue-500 transition-colors">
                                        <span className="h-px w-10 bg-blue-600/30 group-hover:w-16 transition-all" /> 
                                        {item.title}
                                    </h3>
                ...
                <div className="w-full lg:w-[45%] relative shrink-0">
                    <div className={cn(
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center">
                            <Globe className="h-24 w-24 text-blue-600 mb-12 animate-pulse opacity-60" />
