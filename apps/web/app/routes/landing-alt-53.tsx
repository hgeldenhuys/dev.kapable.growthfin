...
export default function LandingAlt53() {
  ...
  return (
    <div className={cn(
      ...
      <nav className={cn(
        ...
        theme === "dark" ? "border-white/5 bg-black/40 backdrop-blur-xl" : "border-slate-200 bg-white/70 backdrop-blur-xl shadow-sm"
      )}>
        <div className="container mx-auto px-10 h-24 flex items-center justify-between">
          <div className="flex items-center gap-5 group cursor-pointer text-left">
            <div className="h-11 w-11 bg-blue-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-600/30 group-hover:scale-105 transition-transform">
              <Mountain className="h-6 w-6 text-white" />
            </div>
            <div className="flex flex-col">
              <span className="text-2xl font-black tracking-tight leading-none uppercase italic">Agios<span className="text-blue-600">.</span>OS</span>
      ...
      {/* Hero Section: Engineered for Perfect Verticality & Spacing */}
      <section className="relative h-screen flex flex-col items-center justify-center px-10 overflow-hidden text-center shrink-0">
        <div className="container mx-auto relative z-10 flex flex-col items-center justify-center h-full pt-12">
            <motion.div
                ...
                className="flex flex-col items-center max-w-[1500px] -mt-24"
            >
                <Badge className={cn(
                    ...
                    Lead Orchestration for Cape Fintech // v4.6
                </Badge>
                
                <h1 className="text-6xl md:text-8xl lg:text-[12rem] font-black tracking-tighter mb-10 leading-[0.8] uppercase italic text-center shrink-0">
                ...
                <p className="text-xl md:text-2xl lg:text-3xl opacity-50 max-w-5xl mx-auto mb-20 font-light leading-relaxed tracking-tight shrink-0 text-center">
                    Agios AI is the high-fidelity orchestration layer for South Africa's most aggressive financial lead generation pipelines. Autonomous, hardened, and infinitely scalable.
                </p>
        ...
        {/* Tactical Status Line - Absolute Bottom with Clean Alignment */}
        <div className={cn(
      ...
      {/* Section: Pipeline Grid - Improved whitespace and light mode friendliness */}
      <section id="pipeline" className={cn(
        ...
        <div className="container mx-auto px-16 max-w-[1600px]">
            <div className="max-w-4xl text-left mb-64 space-y-6">
                ...
                <h2 className="text-7xl md:text-[9rem] font-black uppercase italic tracking-tighter leading-[0.8] text-current">The Pipeline <br /> <span className="text-blue-600 not-italic">Engine.</span></h2>
                <p className="text-2xl md:text-3xl opacity-40 font-light max-w-2xl leading-relaxed tracking-tight text-left">Industrial-strength qualification at absolute scale. Built for the high-velocity fintech economy.</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-64 text-left">
                <div className="flex-1 space-y-32 text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-24 text-left">
                        {[
                            { title: "Market Sourcing", desc: "Autonomous agents scan the digital landscape for real-time intent signals across 50M+ data points.", icon: <Globe className="h-10 w-10 text-blue-600" /> },
                            { title: "Neural Scoring", desc: "Proprietary qualification models built on localized financial readiness and FSR credit data models.", icon: <Fingerprint className="h-10 w-10 text-blue-600" /> },
                        ].map((item, i) => (
                            <div key={i} className="space-y-10 group text-left">
                                ...
                                <div className="space-y-6">
                                    <h3 className="text-2xl font-black uppercase tracking-widest text-blue-600 flex items-center gap-6 italic group-hover:text-blue-500 transition-colors leading-none">
                    ...
                    <div className={cn(
                        ...
                        <div className="flex-1 flex flex-col justify-center items-center relative">
                            ...
                            <div className="text-center space-y-6 relative">
                                ...
                                <div className="text-6xl lg:text-8xl font-black italic uppercase tracking-tighter leading-none relative z-10 text-current leading-none">Synchronized</div>
      ...
      <section id="compliance" className={cn(
        ...
        <div className="container mx-auto px-16 max-w-[1400px] text-center space-y-40">
            ...
            <div className="space-y-16 text-left md:text-center">
                ...
                <p className="text-2xl md:text-4xl lg:text-5xl opacity-50 font-light leading-relaxed max-w-6xl mx-auto tracking-tight text-center text-current leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center gap-40 pt-10 opacity-60">
                {["POPIA Verified", "Bank Grade", "Localized Nodes", "Zero Trust Architecture"].map((tag, i) => (
                    <div key={i} className="flex items-center gap-8 group text-current">
      ...
      <footer className={cn(
        ...
        <div className="container mx-auto px-20">
            ...
            <div className="pt-24 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-24 opacity-20 text-[14px] font-black uppercase tracking-[1.2em] text-left leading-none text-current">
                ...
                <div className="flex gap-32 italic text-left text-current leading-none">
                    <span>Precision.</span>
                    <span>Power.</span>
                    <span>Absolute.</span>
                </div>
